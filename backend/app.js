...
app.use((req, res, next) => {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'Origin, X-Requested-With, Content, Accept, Content-Type, Authorization, Cache-Control'); // ajout des headers mentionnés aux requetes envoyées vers notre api'
